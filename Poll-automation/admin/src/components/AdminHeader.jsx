...
import { LogOut, Zap, ChevronDown, ChevronUp } from 'lucide-react';
    ...
    <header style={headerStyle}>
      ...
      <div 
        style={{
          ...
          color: '#1a1c2e',
          opacity: 0,
          animation: 'headerWelcomeTextAnimation 1s ease forwards 0.5s, welcomeAdminPulse 3s infinite ease-in-out',
          cursor: 'pointer',
          transition: 'all 0.3s ease',
        }}
        onMouseEnter={e => {
      ...
      >
        Welcome<span style={{ background: 'linear-gradient(135deg, #6366F1 0%, #8B5CF6 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Admin</span>
      </div>
